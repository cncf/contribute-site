...
That's why some high-traffic CNCF projects like [OpenTelemetry](https://opentelemetry.io) and [Envoy Gateway](https://gateway.envoyproxy.io) have already turned to Kapa.ai for help. Both projects are using Kapa to handle thousands of community questions every month, freeing up their maintainers to focus on what matters most.

The CNCF is pleased to announce a partnership with [Kapa.ai](https://kapa.ai). Through this collaboration, CNCF-hosted projects can now access Kapa.ai's AI-powered technical assistants for free.
