...
For further information on securing the code repository, we recommend reviewing the **GitOps section** of the [CNCF Cloud Native Security Whitepaper](/community/tags/security-and-compliance/publications/security-whitepaper/#gitopsnew-in-v2) and the **Control Environments** sections of the [CNCF Software Supply Chain Best Practices paper](/projects/best-practices/security/supply-chain/supply-chain-security-paper)
...
[1]: /community/tags/security-and-compliance/publications/security-whitepaper/
[2]: /projects/best-practices/security/supply-chain/supply-chain-security-paper
[3]: https://cnsmap.github.io/
[4]: https://bestpractices.coreinfrastructure.org/en
[5]: /community/tags/security-and-compliance/publications/
