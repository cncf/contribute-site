...
The [cloud native Slack workspace](https://cloud-native.slack.com) is owned and
...
- **Availability of several channels** - you can set up as many public or private channels as you need to support your communities

:::note

New members can join by inviting themselves via [slack.cncf.io](https://slack.cncf.io/) then browsing and joining public channels beyond the 4 defaults.
