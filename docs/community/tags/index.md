...
- TAG Security → TAG Security and Compliance
- TAG Storage → TAG Infrastructure
- TAG App Delivery → TAG Developer Experience
- TAG Network → TAG Infrastructure
- TAG Runtime → TAG Workloads Foundation
- TAG Contributor Strategy → TOC Subproject: Contributor Strategy and Advocacy
- TAG Observability → TAG Operational Resilience
- TAG Environmental Sustainability → TAG Operational Resilience
...
- **CNCF Slack**: [#toc](https://cloud-native.slack.com/archives/C0MP69YF4)
