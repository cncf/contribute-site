...
- [Kusari Gadget](https://docs.kusari.cloud/docs/Inspector/) gives full visibility into versions, licenses, and security risks for direct and transitive dependencies. [Learn more here](https://contribute.cncf.io/blog/2025/12/17/cloud-native-project-monthly-december-2025#%EF%B8%8F-kusari-gadget-free-for-projects).
