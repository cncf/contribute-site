...
- [LastPass](https://www.lastpass.com/), [1Password](https://github.com/1Password/1password-teams-open-source), and [Keybase](https://keybase.io) to manage access to shared secrets. [Proton Password Manager](https://proton.me/pass) also provides a password manager system with an emphasis on security and privacy.
